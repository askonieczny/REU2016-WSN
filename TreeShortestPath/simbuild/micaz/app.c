...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b2f793f1cf8, const void *arg_0x2b2f793f0020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b2f79472618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b2f796b38e8), 
int (*key_eq_fn)(void *arg_0x2b2f796b20c8, void *arg_0x2b2f796b2368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b2f798c3610, int arg_0x2b2f798c3878);
static double RandomUniform(void );
...
bool RadioCountToLedsC$routReceived[1000];
bool RadioCountToLedsC$pathPresent[1000];
bool RadioCountToLedsC$rcmReceived[1000];
float RadioCountToLedsC$numForNode[1000];
float RadioCountToLedsC$windForNode[1000];
float RadioCountToLedsC$tempForNode[1000];
float RadioCountToLedsC$humForNode[1000];
nx_int32_t RadioCountToLedsC$path[1000];
nx_int32_t RadioCountToLedsC$rout[1000];
...
# 135 "RadioCountToLedsC.nc"
static inline message_t *RadioCountToLedsC$Receive$receive(message_t *bufPtr, 
void *payload, uint8_t len)
#line 136
{
  sim_log_debug(149U, "RadioCountToLedsC", "Received packet of length %hhu.\n", len);
...
#line 144
        __nesc_hton_int32(RadioCountToLedsC$rout[sim_node()].nxdata, __nesc_ntoh_int32(r->routing.nxdata));
        sim_log_debug(150U, "RadioCountToLedsC", "Routing protocol for this node is %d\n", __nesc_ntoh_int32(RadioCountToLedsC$rout[sim_node()].nxdata));
        RadioCountToLedsC$routReceived[sim_node()] = TRUE;
        return bufPtr;
      }
    else {
...
#line 153
          __nesc_hton_int32(RadioCountToLedsC$path[sim_node()].nxdata, __nesc_ntoh_int32(pm->path.nxdata));
          sim_log_debug(151U, "RadioCountToLedsC", "Received instruction to send to %d\n", __nesc_ntoh_int32(RadioCountToLedsC$path[sim_node()].nxdata));
          RadioCountToLedsC$pathPresent[sim_node()] = TRUE;
          return bufPtr;
        }
      else {
...
#line 161
          RadioCountToLedsC$windForNode[sim_node()] += __nesc_ntoh_uint32(rcm->wind.nxdata);
          RadioCountToLedsC$humForNode[sim_node()] += __nesc_ntoh_uint32(rcm->hum.nxdata);
          RadioCountToLedsC$tempForNode[sim_node()] += __nesc_ntoh_uint32(rcm->temp.nxdata);
          RadioCountToLedsC$numForNode[sim_node()] += __nesc_ntoh_uint32(rcm->num.nxdata);
          RadioCountToLedsC$rcmReceived[sim_node()] = TRUE;
          sim_log_debug(152U, "RadioCountToLedsC", "Current average wind is: %.3f\n", RadioCountToLedsC$windForNode[sim_node()] / RadioCountToLedsC$numForNode[sim_node()]);
          sim_log_debug(153U, "RadioCountToLedsC", "Current average humidity is: %.3f\n", RadioCountToLedsC$humForNode[sim_node()] / RadioCountToLedsC$numForNode[sim_node()]);
          sim_log_debug(154U, "RadioCountToLedsC", "Current average temperature is: %.3f\n", RadioCountToLedsC$tempForNode[sim_node()] / RadioCountToLedsC$numForNode[sim_node()]);
          return bufPtr;
        }
      }
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b2f79cb1340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b2f79cb1340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b2f79cb1340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b2f79cb0020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b2f79cb0020, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b2f79cb2220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b2f79cb2220, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b2f79f37788, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b2f79f37788) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b2f79f37788, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b2f799c4020){
#line 75
  switch (arg_0x2b2f799c4020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b2f799c4020);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b2f79f36960, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b2f79f36960, addr, msg, len);
#line 80
...
#line 109
{
  ...
  if (((RadioCountToLedsC$locked[sim_node()] || !RadioCountToLedsC$pathPresent[sim_node()]) || !RadioCountToLedsC$rcmReceived[sim_node()]) || !RadioCountToLedsC$routReceived[sim_node()]) {
      return;
    }
  else 
...
#line 118
      ...
      __nesc_hton_uint32(rcm->wind.nxdata, RadioCountToLedsC$windForNode[sim_node()]);
      __nesc_hton_uint32(rcm->hum.nxdata, RadioCountToLedsC$humForNode[sim_node()]);
      __nesc_hton_uint32(rcm->temp.nxdata, RadioCountToLedsC$tempForNode[sim_node()]);
      __nesc_hton_uint32(rcm->num.nxdata, RadioCountToLedsC$numForNode[sim_node()]);
      if (__nesc_ntoh_int32(RadioCountToLedsC$path[sim_node()].nxdata) != -1) {
          if (RadioCountToLedsC$AMSend$send(__nesc_ntoh_int32(RadioCountToLedsC$path[sim_node()].nxdata), &RadioCountToLedsC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
              sim_log_debug(148U, "RadioCountToLedsC", "Sent radio count packet to %i\n", __nesc_ntoh_int32(RadioCountToLedsC$path[sim_node()].nxdata));
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b2f7a1bec28){
#line 83
  switch (arg_0x2b2f7a1bec28) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b2f7a1bec28);
#line 83
      break;
#line 83
    }
...
#line 57
  {
    sim_log_debug(155U, "Init", "LEDS: initialized.\n");
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioCountToLedsC$routReceived"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$routReceived[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$routReceived[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$pathPresent"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$pathPresent[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$pathPresent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$rcmReceived"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$rcmReceived[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$rcmReceived[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$numForNode"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$numForNode[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$numForNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$windForNode"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$windForNode[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$windForNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$tempForNode"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$tempForNode[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$tempForNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$humForNode"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$humForNode[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$humForNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$path"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$path[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$path[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioCountToLedsC$rout"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$rout[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$rout[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  RadioCountToLedsC$routReceived[__nesc_mote] = FALSE;
  RadioCountToLedsC$pathPresent[__nesc_mote] = FALSE;
  RadioCountToLedsC$rcmReceived[__nesc_mote] = FALSE;
  RadioCountToLedsC$numForNode[__nesc_mote] = 0;
  RadioCountToLedsC$windForNode[__nesc_mote] = 0;
  RadioCountToLedsC$tempForNode[__nesc_mote] = 0;
  RadioCountToLedsC$humForNode[__nesc_mote] = 0;
  memset((void *)&RadioCountToLedsC$path[__nesc_mote], 0, sizeof RadioCountToLedsC$path[__nesc_mote]);
  memset((void *)&RadioCountToLedsC$rout[__nesc_mote], 0, sizeof RadioCountToLedsC$rout[__nesc_mote]);
