...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b61d6203cf8, const void *arg_0x2b61d6202020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b61d6284618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b61d64c58e8), 
int (*key_eq_fn)(void *arg_0x2b61d64c40c8, void *arg_0x2b61d64c4368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b61d66d5610, int arg_0x2b61d66d5878);
static double RandomUniform(void );
...
typedef nx_struct path_msg {
  nx_int32_t path;
} __attribute__((packed)) path_msg_t;
...
typedef TMilli SumNodesC$MilliTimer$precision_tag;
...
static void SumNodesC$AMControl$startDone(error_t error);
#line 138
static void SumNodesC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void SumNodesC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void SumNodesC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void SumNodesC$MilliTimer$fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t LedsP$Init$init(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SumNodesC$AMControl$start(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t SumNodesC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SumNodesC$MilliTimer$startPeriodic(uint32_t dt);
# 19 "SumNodesC.nc"
message_t SumNodesC$packet[1000];

bool SumNodesC$locked[1000];
bool SumNodesC$pathPresent[1000];
bool SumNodesC$rcmReceived[1000];
uint16_t SumNodesC$valForNode[1000];
nx_int32_t SumNodesC$path[1000];

static inline void SumNodesC$Boot$booted(void );



static inline void SumNodesC$AMControl$startDone(error_t err);
...
static inline void SumNodesC$AMControl$stopDone(error_t err);



static inline void SumNodesC$MilliTimer$fired(void );
#line 65
static inline message_t *SumNodesC$Receive$receive(message_t *bufPtr, 
void *payload, uint8_t len);
#line 90
static inline void SumNodesC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 46 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
#line 66
{
  sim_log_debug(149U, "SumNodesC", "Received packet of length %hhu.\n", len);
  if (len != sizeof(radio_count_msg_t ) && len != sizeof(path_msg_t )) {
      return bufPtr;
    }
  else {
#line 71
    if (len == sizeof(path_msg_t )) {

        path_msg_t *pm = (path_msg_t *)payload;

#line 74
        __nesc_hton_int32(SumNodesC$path[sim_node()].nxdata, __nesc_ntoh_int32(pm->path.nxdata));
        sim_log_debug(150U, "SumNodesC", "Recieved instruction to send to %d\n", __nesc_ntoh_int32(SumNodesC$path[sim_node()].nxdata));
        SumNodesC$pathPresent[sim_node()] = TRUE;
        return bufPtr;
      }
    else {
...
#line 82
        SumNodesC$valForNode[sim_node()] += __nesc_ntoh_uint16(rcm->val.nxdata);
        SumNodesC$rcmReceived[sim_node()] = TRUE;
        sim_log_debug(151U, "SumNodesC", "The current sum is: %i\n", SumNodesC$valForNode[sim_node()]);
        return bufPtr;
      }
    }
}
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b61d6ac5340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b61d6ac5340) {
#line 78
    case 6:
#line 78
      __nesc_result = SumNodesC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b61d6ac5340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b61d6ac4020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b61d6ac4020, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SumNodesC$AMControl$start(void ){
#line 104
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SumNodesC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      SumNodesC$MilliTimer$startPeriodic(250);
    }
  else {
      SumNodesC$AMControl$start();
    }
}
...
#line 113
  SumNodesC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  SumNodesC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b61d6ac7220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b61d6ac7220, msg, error);
#line 110
}
#line 110
...
#line 90
{
  if (&SumNodesC$packet[sim_node()] == bufPtr) {
      SumNodesC$locked[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SumNodesC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b61d6d59318, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b61d6d59318) {
#line 100
    case 0U:
#line 100
      /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b61d6d59318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b61d67d6020){
#line 75
  switch (arg_0x2b61d67d6020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b61d67d6020);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b61d6d58488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b61d6d58488, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SumNodesC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SumNodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * SumNodesC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 44
{
  ...
  if ((SumNodesC$locked[sim_node()] || !SumNodesC$pathPresent[sim_node()]) || !SumNodesC$rcmReceived[sim_node()]) {
      return;
    }
  else 
    {
      radio_count_msg_t *rcm = (radio_count_msg_t *)SumNodesC$Packet$getPayload(&SumNodesC$packet[sim_node()], sizeof(radio_count_msg_t ));

#line 52
      if (rcm == (void *)0) {
          return;
        }
      __nesc_hton_uint16(rcm->val.nxdata, SumNodesC$valForNode[sim_node()]);
      if (__nesc_ntoh_int32(SumNodesC$path[sim_node()].nxdata) != -1) {
          if (SumNodesC$AMSend$send(__nesc_ntoh_int32(SumNodesC$path[sim_node()].nxdata), &SumNodesC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
              sim_log_debug(148U, "SumNodesC", "Send radio count packet to %i\n", __nesc_ntoh_int32(SumNodesC$path[sim_node()].nxdata));
              SumNodesC$locked[sim_node()] = TRUE;
            }
        }
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b61d6fe1c28){
#line 83
  switch (arg_0x2b61d6fe1c28) {
#line 83
    case 0U:
#line 83
      SumNodesC$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b61d6fe1c28);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module SumNodesC */
  if (!strcmp(varname, "SumNodesC$packet"))
  {
    *addr = (uintptr_t)&SumNodesC$packet[__nesc_mote];
    *size = sizeof(SumNodesC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SumNodesC$locked"))
  {
    *addr = (uintptr_t)&SumNodesC$locked[__nesc_mote];
    *size = sizeof(SumNodesC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SumNodesC$pathPresent"))
  {
    *addr = (uintptr_t)&SumNodesC$pathPresent[__nesc_mote];
    *size = sizeof(SumNodesC$pathPresent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SumNodesC$rcmReceived"))
  {
    *addr = (uintptr_t)&SumNodesC$rcmReceived[__nesc_mote];
    *size = sizeof(SumNodesC$rcmReceived[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SumNodesC$valForNode"))
  {
    *addr = (uintptr_t)&SumNodesC$valForNode[__nesc_mote];
    *size = sizeof(SumNodesC$valForNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SumNodesC$path"))
  {
    *addr = (uintptr_t)&SumNodesC$path[__nesc_mote];
    *size = sizeof(SumNodesC$path[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SumNodesC */
  memset((void *)&SumNodesC$packet[__nesc_mote], 0, sizeof SumNodesC$packet[__nesc_mote]);
  memset((void *)&SumNodesC$locked[__nesc_mote], 0, sizeof SumNodesC$locked[__nesc_mote]);
  SumNodesC$pathPresent[__nesc_mote] = FALSE;
  SumNodesC$rcmReceived[__nesc_mote] = FALSE;
  SumNodesC$valForNode[__nesc_mote] = 0;
  memset((void *)&SumNodesC$path[__nesc_mote], 0, sizeof SumNodesC$path[__nesc_mote]);
