...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2af8965f9cf8, const void *arg_0x2af8965f8020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2af89667a618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2af8968bb8e8), 
int (*key_eq_fn)(void *arg_0x2af8968ba0c8, void *arg_0x2af8968ba368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2af896acb610, int arg_0x2af896acb878);
static double RandomUniform(void );
...
collection_id_t arg_0x2af8978d1c00, 
...
collection_id_t arg_0x2af8978d10c8, 
# 71 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
collection_id_t arg_0x2af8978d24d0, 
# 71 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
float TestNetworkC$wind_AODV[1000];
float TestNetworkC$temp_AODV[1000];
float TestNetworkC$hum_AODV[1000];
float TestNetworkC$num_AODV[1000];
...
static uint8_t /*CtpP.Router*/CtpRoutingEngineP$0$routingTableFind(am_addr_t arg_0x2af897c03678);
static inline error_t /*CtpP.Router*/CtpRoutingEngineP$0$routingTableUpdateEntry(am_addr_t arg_0x2af897c02020, am_addr_t arg_0x2af897c022e8, uint16_t arg_0x2af897c025a8);
...
#line 666
{
  ...
  if (__nesc_ntoh_int32(AODV_M$protocol[sim_node()].nxdata) == 2) {
      ...
      if (!AODV_M$is_rreq_cached(aodv_hdr)) {
          sim_log_debug(207U, "AODV_DBG", "%s\t AODV: ReceiveRREQ.receive() already received one\n", sim_time_string());
...
#line 734
  ...
  sim_log_debug(208U, "AODV", "%s\t AODV: ReceiveRREP.receive() src: %d dest: %d \n", sim_time_string(), __nesc_ntoh_uint16(aodv_hdr->src.nxdata), __nesc_ntoh_uint16(aodv_hdr->dest.nxdata));
...
#line 762
  sim_log_debug(209U, "AODV", "%s\t AODV: ReceiveRERR.receive()\n", sim_time_string());
...
#line 527
{
  ...
  if (AODV_M$msg_pending_[sim_node()]) {
      sim_log_debug(196U, "AODV", "%s\t AODV: forwardMSG() msg_pending_\n", sim_time_string());
      return FAIL;
    }
  sim_log_debug(197U, "AODV_DBG", "%s\t AODV: forwardMSG() try to forward to %d \n", sim_time_string(), nexthop);
  ...
  for (i = 0; i < 3; i++) {
      if (i == 0) {
          __nesc_hton_uint16(msg_aodv_hdr->data[i].nxdata, rand() % 40 + 40);
        }
      else {
#line 548
        if (i == 1) {
            __nesc_hton_uint16(msg_aodv_hdr->data[i].nxdata, rand() % 20 + 70);
          }
        else {
            __nesc_hton_uint16(msg_aodv_hdr->data[i].nxdata, rand() % 20);
          }
        }
    }
  ...
  if (AODV_M$SubSend$send(nexthop, AODV_M$p_aodv_msg_[sim_node()], len) == SUCCESS) {
      sim_log_debug(198U, "AODV", "%s\t AODV: forwardMSG() send MSG to: %d\n", sim_time_string(), nexthop);
...
#line 563
    {
      sim_log_debug(199U, "AODV", "%s\t AODV: forwardMSG() fail to send\n", sim_time_string());
...
#line 353
{
  if (__nesc_ntoh_int32(TestNetworkC$prot[sim_node()].nxdata) == 2) {
      aodv_msg_hdr *rcm = (aodv_msg_hdr *)payload;

#line 356
      sim_log_debug(61U, "AODV", "%s\t Received!!!!\n", sim_time_string());
      if (__nesc_ntoh_uint16(rcm->data[0].nxdata) != 0) {
          TestNetworkC$temp_AODV[sim_node()] += __nesc_ntoh_uint16(rcm->data[0].nxdata);
          TestNetworkC$hum_AODV[sim_node()] += __nesc_ntoh_uint16(rcm->data[1].nxdata);
          TestNetworkC$wind_AODV[sim_node()] += __nesc_ntoh_uint16(rcm->data[2].nxdata);
          TestNetworkC$num_AODV[sim_node()]++;
          sim_log_debug(62U, "AODV", "THIS IS AODVTEMP: %.3f\n", __nesc_ntoh_uint16(rcm->data[0].nxdata) / TestNetworkC$num_AODV[sim_node()]);
          sim_log_debug(63U, "AODV", "THIS IS AODVHUM: %.3f\n", __nesc_ntoh_uint16(rcm->data[1].nxdata) / TestNetworkC$num_AODV[sim_node()]);
          sim_log_debug(64U, "AODV", "THIS IS AODVWIND: %.3f\n", __nesc_ntoh_uint16(rcm->data[2].nxdata) / TestNetworkC$num_AODV[sim_node()]);
        }
    }
  return msg;
}
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * AODV_M$Receive$receive(uint8_t arg_0x2af897237020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2af897237020) {
#line 78
    case 1:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = AODV_M$Receive$default$receive(arg_0x2af897237020, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 850
      sim_log_debug(215U, "AODV", "%s\t AODV: SubReceive.receive() deliver to next hop:%x\n", sim_time_string(), nexthop);
...
# 85 "/opt/tinyos-2.1.2/tos/lib/net/TrickleTimer.nc"
inline static void DisseminationEngineImplP$TrickleTimer$incrementCounter(uint16_t arg_0x2af8976f2df0){
#line 85
  switch (arg_0x2af8976f2df0) {
#line 85
    case 1:
#line 85
...
#line 85
    default:
#line 85
      DisseminationEngineImplP$TrickleTimer$default$incrementCounter(arg_0x2af8976f2df0);
#line 85
      break;
#line 85
    }
...
# 80 "/opt/tinyos-2.1.2/tos/lib/net/TrickleTimer.nc"
inline static void DisseminationEngineImplP$TrickleTimer$reset(uint16_t arg_0x2af8976f2df0){
#line 80
  switch (arg_0x2af8976f2df0) {
#line 80
    case 1:
...
#line 80
    default:
#line 80
      DisseminationEngineImplP$TrickleTimer$default$reset(arg_0x2af8976f2df0);
#line 80
      break;
#line 80
    }
...
# 48 "/opt/tinyos-2.1.2/tos/lib/net/drip/DisseminationCache.nc"
inline static void DisseminationEngineImplP$DisseminationCache$storeData(uint16_t arg_0x2af8976f3a40, void * data, uint8_t size, uint32_t seqno){
#line 48
  switch (arg_0x2af8976f3a40) {
#line 48
    case 1:
#line 48
...
#line 48
    default:
#line 48
      DisseminationEngineImplP$DisseminationCache$default$storeData(arg_0x2af8976f3a40, data, size, seqno);
#line 48
      break;
#line 48
    }
...
# 49 "/opt/tinyos-2.1.2/tos/lib/net/drip/DisseminationCache.nc"
inline static uint32_t DisseminationEngineImplP$DisseminationCache$requestSeqno(uint16_t arg_0x2af8976f3a40){
#line 49
  unsigned int __nesc_result;
#line 49
...
#line 49
    default:
#line 49
      __nesc_result = DisseminationEngineImplP$DisseminationCache$default$requestSeqno(arg_0x2af8976f3a40);
#line 49
      break;
#line 49
    }
...
#line 181
  ...
  if ((int32_t )(incomingSeqno - currentSeqno) > 0) {
      ...
      len - sizeof(dissemination_message_t ), 
      incomingSeqno);
      sim_log_debug(252U, "Dissemination", "Received dissemination value 0x%08x,0x%08x @ %s\n", (int )key, (int )incomingSeqno, sim_time_string());
      DisseminationEngineImplP$TrickleTimer$reset(key);
    }
  else {
#line 211
...
#line 578
{
  if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$MessagePool$empty()) {
      sim_log_debug(289U, "Route", "%s cannot forward, message pool empty.\n", __FUNCTION__);
...
#line 584
    if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$QEntryPool$empty()) {
        sim_log_debug(290U, "Route", "%s cannot forward, queue entry pool empty.\n", __FUNCTION__);
        ...
        if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$enqueue(qe) == SUCCESS) {
            sim_log_debug(291U, "Forwarder,Route", "%s forwarding packet %p with queue size %hhu\n", __FUNCTION__, m, /*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$size());
...
# 31 "/opt/tinyos-2.1.2/tos/interfaces/Intercept.nc"
inline static bool /*CtpP.Forwarder*/CtpForwardingEngineP$0$Intercept$forward(collection_id_t arg_0x2af8978d1c00, message_t * msg, void * payload, uint8_t len){
#line 31
  unsigned char __nesc_result;
#line 31

#line 31
    __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Intercept$default$forward(arg_0x2af8978d1c00, msg, payload, len);
#line 31
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*CtpP.Forwarder*/CtpForwardingEngineP$0$Receive$receive(collection_id_t arg_0x2af8978d24d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2af8978d24d0) {
#line 78
    case CL_TEST:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Receive$default$receive(arg_0x2af8978d24d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
inline static uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$maxPayloadLength(am_id_t arg_0x2af8973de020){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = TossimActiveMessageC$AMSend$maxPayloadLength(arg_0x2af8973de020);
#line 123
...
#line 715
  ...
  if (idx == 10) {
      ...
      sim_log_debug(366U, "TreeRouting", "%s FAIL, table full\n", __FUNCTION__);
      return FAIL;
    }
  else {
#line 726
    if (idx == /*CtpP.Router*/CtpRoutingEngineP$0$routingTableActive[sim_node()]) {
        ...
        if (/*CtpP.Router*/CtpRoutingEngineP$0$passLinkEtxThreshold(linkEtx)) {
            ...
            sim_log_debug(367U, "TreeRouting", "%s OK, new entry\n", __FUNCTION__);
          }
        else 
#line 736
          {
            sim_log_debug(368U, "TreeRouting", "%s Fail, link quality (%hu) below threshold\n", __FUNCTION__, linkEtx);
          }
      }
    else 
#line 739
      {
        ...
        /*CtpP.Router*/CtpRoutingEngineP$0$routingTable[sim_node()][idx].info.etx = etx;
        /*CtpP.Router*/CtpRoutingEngineP$0$routingTable[sim_node()][idx].info.haveHeard = 1;
        sim_log_debug(369U, "TreeRouting", "%s OK, updated entry\n", __FUNCTION__);
      }
    }
#line 747
  return SUCCESS;
...
#line 461
{
  ...
  if (nidx != LinkEstimatorP$INVALID_RVAL) {
      sim_log_debug(333U, "LI", "insert: Found the entry, no need to insert\n");
      return SUCCESS;
    }

  nidx = LinkEstimatorP$findEmptyNeighborIdx();
  if (nidx != LinkEstimatorP$INVALID_RVAL) {
      sim_log_debug(334U, "LI", "insert: inserted into the empty slot\n");
...
#line 475
    {
      ...
      if (nidx != LinkEstimatorP$INVALID_RVAL) {
          sim_log_debug(335U, "LI", "insert: inserted by replacing an entry for neighbor: %d\n", LinkEstimatorP$NeighborTable[sim_node()][nidx].ll_addr);
...
#line 467
{
  ...
  if (len != sizeof(ctp_routing_header_t )) {
      sim_log_debug(360U, "LITest", "%s, received beacon of size %hhu, expected %i\n", __FUNCTION__, len, (int )sizeof(ctp_routing_header_t ));
  ...
  if (__nesc_ntoh_uint16(rcvBeacon->parent.nxdata) != INVALID_ADDR) {
      ...
      if (__nesc_ntoh_uint16(rcvBeacon->etx.nxdata) == 0) {
          sim_log_debug(362U, "TreeRouting", "from a root, inserting if not in table\n");
...
#line 590
{
  ...
  sim_log_debug(338U, "LI", "LI receiving packet, buf addr: %x\n", payload);
  ...
  if (LinkEstimatorP$SubAMPacket$destination(msg) == AM_BROADCAST_ADDR) {
      ...
      sim_log_debug(339U, "LI", "Got seq: %d from link: %d\n", __nesc_ntoh_uint8(hdr->seq.nxdata), ll_addr);
...
#line 622
      ...
      if (nidx != LinkEstimatorP$INVALID_RVAL) {
          sim_log_debug(340U, "LI", "Found the entry so updating\n");
...
#line 626
        {
          nidx = LinkEstimatorP$findEmptyNeighborIdx();
          if (nidx != LinkEstimatorP$INVALID_RVAL) {
              sim_log_debug(341U, "LI", "Found an empty entry\n");
...
#line 640
                {
                  sim_log_debug(343U, "LI", "No room in the table\n");
...
#line 670
{
  sim_log_debug(344U, "LI", "Received upper packet. Will signal up\n");
...
#line 262
{
  sim_log_debug(269U, "FHangBug", "%s posted sendTask.\n", __FUNCTION__);
  /*CtpP.Forwarder*/CtpForwardingEngineP$0$sendTask$postTask();
}
...
#line 610
  sim_log_debug(364U, "TreeRouting", "%s I'm a root now!\n", __FUNCTION__);
...
#line 428
{
  sim_log_debug(331U, "LI", "Link estimator start\n");
  return SUCCESS;
}
...
#line 110
  ...
  sim_log_debug(253U, "Trickle", "Starting trickle timer %hhu @ %s\n", id, sim_time_string());
  return SUCCESS;
}
...
# 68 "/opt/tinyos-2.1.2/tos/lib/net/TrickleTimer.nc"
inline static error_t DisseminationEngineImplP$TrickleTimer$start(uint16_t arg_0x2af8976f2df0){
#line 68
  unsigned char __nesc_result;
#line 68
...
#line 68
    default:
#line 68
      __nesc_result = DisseminationEngineImplP$TrickleTimer$default$start(arg_0x2af8976f2df0);
#line 68
      break;
#line 68
    }
...
# 95 "/opt/tinyos-2.1.2/tos/interfaces/StdControl.nc"
inline static error_t DisseminationEngineImplP$DisseminatorControl$start(uint16_t arg_0x2af8976f00c8){
#line 95
  unsigned char __nesc_result;
#line 95

#line 95
  switch (arg_0x2af8976f00c8) {
#line 95
...
#line 95
    default:
#line 95
      __nesc_result = DisseminationEngineImplP$DisseminatorControl$default$start(arg_0x2af8976f00c8);
#line 95
      break;
#line 95
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2af89701b220, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2af89701b220) {
#line 78
    case 1:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2af89701b220, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2af8973de020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2af8973de020, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2af89701d0c8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2af89701d0c8, msg, error);
#line 110
}
#line 110
...
#line 296
{
  ...
  sim_log_debug(154U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 311
    if (mine == CpmModelC$outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(155U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 317
  sim_log_debug(156U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC$checkReceive(mine)) {
      sim_log_debug(157U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
  if (! mine->lost) {
...
#line 327
      ...
      sim_log_debug_clear(158U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(159U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(160U, "CpmModelC", " no acknowledgment requested.\n");
        }
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*CtpP.Forwarder*/CtpForwardingEngineP$0$Send$sendDone(uint8_t arg_0x2af8978d3368, message_t * msg, error_t error){
#line 100
  switch (arg_0x2af8978d3368) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*CtpP.Forwarder*/CtpForwardingEngineP$0$Send$default$sendDone(arg_0x2af8978d3368, msg, error);
#line 100
      break;
#line 100
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void AODV_M$AMSend$sendDone(am_id_t arg_0x2af897239e38, message_t * msg, error_t error){
#line 110
  switch (arg_0x2af897239e38) {
#line 110
    case 1:
#line 110
...
#line 110
    default:
#line 110
      AODV_M$AMSend$default$sendDone(arg_0x2af897239e38, msg, error);
#line 110
      break;
#line 110
    }
...
#line 811
        {
          ...
          if (AODV_M$msg_retries_[sim_node()] > 0) {
              sim_log_debug(211U, "AODV", "%s\t AODV: SubSend.sendDone() msg was not acked, resend\n", sim_time_string());
...
#line 819
            {
              sim_log_debug(212U, "AODV", "%s\t AODV: SubSend.sendDone() route may be corrupted\n", sim_time_string());
...
#line 650
{
  sim_log_debug(205U, "AODV_DBG", "%s\t AODV: SendRERR.sendDone() \n", sim_time_string());
  AODV_M$send_pending_[sim_node()] = FALSE;
...
#line 636
{
  sim_log_debug(204U, "AODV_DBG", "%s\t AODV: SendRREP.sendDone()\n", sim_time_string());
  AODV_M$send_pending_[sim_node()] = FALSE;
  if (AODV_M$PacketAcknowledgements$wasAcked(p_msg)) {
...
#line 625
{
  sim_log_debug(203U, "AODV_DBG", "%s\t AODV: SendRREQ.sendDone()\n", sim_time_string());
  AODV_M$send_pending_[sim_node()] = FALSE;
...
#line 324
  ...
  sim_log_debug(321U, "LI", "%s\n", __FUNCTION__);
  for (i = 0; i < 10; i++) {
      ne = &LinkEstimatorP$NeighborTable[sim_node()][i];
      if (ne->ll_addr == n) {
          if (ne->flags & VALID_ENTRY) {
              sim_log_debug(322U, "LI", "Making link: %d mature\n", i);
              ...
              sim_log_debug(323U, "LI", "MinPkt: %d, totalPkt: %d\n", minPkt, totalPkt);
              newEst = 250UL * ne->rcvcnt / totalPkt;
              sim_log_debug(324U, "LI,LITest", "  %hu: %hhu -> %hhu", ne->ll_addr, ne->inquality, (LinkEstimatorP$ALPHA * ne->inquality + (10 - LinkEstimatorP$ALPHA) * newEst) / 10);
...
#line 353
            {
              sim_log_debug(325U, "LI", " - entry %i is invalid.\n", (int )i);
            }
        }
    }
}
...
#line 91
      ...
      sim_log_debug(386U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*TestNetworkAppC.PoolC.PoolP*/PoolP$2$free[sim_node()]);
      return rval;
    }
  return (void *)0;
}
...
# 135 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$getPayload(am_id_t arg_0x2af8973de020, message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = TossimActiveMessageC$AMSend$getPayload(arg_0x2af8973de020, msg, len);
#line 135
...
# 47 "/opt/tinyos-2.1.2/tos/lib/net/drip/DisseminationCache.nc"
inline static void *DisseminationEngineImplP$DisseminationCache$requestData(uint16_t arg_0x2af8976f3a40, uint8_t *size){
#line 47
  void *__nesc_result;
#line 47
...
#line 47
    default:
#line 47
      __nesc_result = DisseminationEngineImplP$DisseminationCache$default$requestData(arg_0x2af8976f3a40, size);
#line 47
      break;
#line 47
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*CtpP.Forwarder*/CtpForwardingEngineP$0$Snoop$receive(collection_id_t arg_0x2af8978d10c8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Snoop$default$receive(arg_0x2af8978d10c8, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2af89701bd68, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2af89701bd68) {
#line 78
    case 113:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2af89701bd68, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 409
{
  sim_log_debug(69U, "Traffic", "CTP node sending packet to UART.\n");
...
#line 416
        sim_log_debug(70U, "Traffic", "Sending packet to UART.\n");
...
#line 239
{
  if (err == SUCCESS) {
      ...
      if (!/*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$empty()) {
          sim_log_debug(267U, "FHangBug", "%s posted sendTask.\n", __FUNCTION__);
          /*CtpP.Forwarder*/CtpForwardingEngineP$0$sendTask$postTask();
        }
    }
}
...
#line 246
{
  ...
  sim_log_debug(348U, "TreeRoutingCtl", "%s running: %d radioOn: %d\n", __FUNCTION__, /*CtpP.Router*/CtpRoutingEngineP$0$running[sim_node()], /*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()]);
  if (/*CtpP.Router*/CtpRoutingEngineP$0$running[sim_node()]) {
      uint16_t nextInt;
...
#line 244
{
  sim_log_debug(190U, "AODV", "%s\t AODV: resendRREQ()\n", sim_time_string());
...
#line 272
      ...
      AODV_M$p_rrep_msg_[sim_node()], sizeof(aodv_rrep_hdr )) == SUCCESS) {
          sim_log_debug(191U, "AODV", "%s\t AODV: resendRREP() to %d\n", sim_time_string(), dest);
          AODV_M$send_pending_[sim_node()] = TRUE;
          AODV_M$rrep_pending_[sim_node()] = FALSE;
        }
    }
...
#line 292
      ...
      AODV_M$p_rerr_msg_[sim_node()], sizeof(aodv_rerr_hdr )) == SUCCESS) {
          sim_log_debug(192U, "AODV", "%s\t AODV: resendRERR() to %d\n", sim_time_string());
          AODV_M$send_pending_[sim_node()] = TRUE;
          AODV_M$rerr_pending_[sim_node()] = FALSE;
        }
    }
...
# 90 "/opt/tinyos-2.1.2/tos/lib/net/TrickleTimer.nc"
inline static void /*DisseminationTimerP.TrickleTimerMilliC.TrickleTimerImplP*/TrickleTimerImplP$0$TrickleTimer$fired(uint8_t arg_0x2af8977c4630){
#line 90
  switch (arg_0x2af8977c4630) {
#line 90
    case /*TestNetworkAppC.Object32C*/DisseminatorC$0$TIMER_ID:
#line 90
...
#line 90
    default:
#line 90
      /*DisseminationTimerP.TrickleTimerMilliC.TrickleTimerImplP*/TrickleTimerImplP$0$TrickleTimer$default$fired(arg_0x2af8977c4630);
#line 90
      break;
#line 90
    }
...
#line 163
        __nesc_atomic_end(__nesc_atomic); }
      if (fire) {
          sim_log_debug(257U, "Trickle", "Firing trickle timer %hhu @ %s\n", i, sim_time_string());
...
#line 373
  sim_log_debug(275U, "Forwarder", "%s: Trying to send a packet. Queue size is %hhu.\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$size());
...
#line 378
    ...
    /*CtpP.Forwarder*/CtpForwardingEngineP$0$CtpInfo$getEtx(&gradient) != SUCCESS) {
        ...
        sim_log_debug(276U, "Forwarder", "%s: no route, don't send, try again in %i.\n", __FUNCTION__, NO_ROUTE_RETRY);
...
#line 412
        ...
        sim_log_debug(277U, "Forwarder", "Sending queue entry %p\n", qe);
        ...
        if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$RootControl$isRoot()) {
            ...
            sim_log_debug(278U, "Forwarder", "%s: I'm a root, so loopback and signal receive.\n", __FUNCTION__);
            ...
            if (subsendResult == SUCCESS) {
                ...
                sim_log_debug(279U, "Forwarder", "%s: subsend succeeded with %p.\n", __FUNCTION__, qe->msg);
                return;
              }
            else {
              if (subsendResult == ESIZE) {
                  sim_log_debug(280U, "Forwarder", "%s: subsend failed from ESIZE: truncate packet.\n", __FUNCTION__);
                  ...
                  sim_log_debug(281U, "Forwarder", "%s: subsend failed from %i\n", __FUNCTION__, (int )subsendResult);
                }
              }
          }
      }
...
#line 123
  sim_log_debug(314U, "LI", "newlen1 = %d\n", len);
  ...
  sim_log_debug(315U, "LI", "Max payload is: %d, maxEntries is: %d\n", LinkEstimatorP$SubPacket$maxPayloadLength(), maxEntries);
...
#line 145
  ...
  sim_log_debug(317U, "LI", "newlen2 = %d\n", newlen);
  return newlen;
}
...
#line 561
  ...
  sim_log_debug(336U, "LITest", "%s packet of length %hhu became %hhu\n", __FUNCTION__, len, newlen);
  sim_log_debug(337U, "LI", "Sending seq: %d\n", LinkEstimatorP$linkEstSeq[sim_node()]);
...
#line 425
    if (eval == EOFF) {
        /*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()] = FALSE;
        sim_log_debug(358U, "TreeRoutingCtl", "%s running: %d radioOn: %d\n", __FUNCTION__, /*CtpP.Router*/CtpRoutingEngineP$0$running[sim_node()], /*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()]);
      }
    }
}
...
# 135 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void * /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$getPayload(am_id_t arg_0x2af8973de020, message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = SerialActiveMessageC$AMSend$getPayload(arg_0x2af8973de020, msg, len);
#line 135
...
#line 277
  ...
  sim_log_debug(350U, "TreeRouting", "%s\n", __FUNCTION__);
  ...
  for (i = 0; i < /*CtpP.Router*/CtpRoutingEngineP$0$routingTableActive[sim_node()]; i++) {
      ...
      if (entry->info.parent == INVALID_ADDR || entry->info.parent == /*CtpP.Router*/CtpRoutingEngineP$0$my_ll_addr[sim_node()]) {
          sim_log_debug(351U, "TreeRouting", "routingTable[%d]: neighbor: [id: %d parent: %d  etx: NO ROUTE]\n", i, entry->neighbor, entry->info.parent);
      ...
      sim_log_debug(352U, "TreeRouting", "routingTable[%d]: neighbor: [id: %d parent: %d etx: %d retx: %d]\n", i, entry->neighbor, entry->info.parent, linkEtx, entry->info.etx);


      pathEtx = linkEtx + entry->info.etx;

      if (entry->neighbor == /*CtpP.Router*/CtpRoutingEngineP$0$routeInfo[sim_node()].parent) {
          sim_log_debug(353U, "TreeRouting", "   already parent.\n");
          currentEtx = pathEtx;
      ...
      if (!/*CtpP.Router*/CtpRoutingEngineP$0$passLinkEtxThreshold(linkEtx)) {
          sim_log_debug(354U, "TreeRouting", "   did not pass threshold.\n");
          continue;
        }

      if (pathEtx < minEtx) {
          sim_log_debug(355U, "TreeRouting", "   best is %d, setting to %d\n", pathEtx, entry->neighbor);
          minEtx = pathEtx;
          best = entry;
        }
    }
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$sendDone(uint8_t arg_0x2af8973e0e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2af8973e0e18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$default$sendDone(arg_0x2af8973e0e18, msg, error);
#line 100
      break;
#line 100
    }
...
#line 82
{
  sim_log_debug(375U, "Serial", "Serial: sending a packet of size %d\n", len);
  return FAIL;
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$send(am_id_t arg_0x2af8973de020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC$AMSend$send(arg_0x2af8973de020, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2af896bcc020){
#line 75
  switch (arg_0x2af896bcc020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2af896bcc020);
#line 75
      break;
#line 75
    }
...
#line 862
{
  sim_log_debug(216U, "AODV_DBG2", "%s\t AODV: Timer.fired()\n", sim_time_string());
...
#line 880
{
  sim_log_debug(217U, "AODV_DBG", "%s\t AODV: RREQTimer.fired()\n", sim_time_string());
...
#line 179
  sim_log_debug(258U, "Trickle", "Trickle Sub-timer fired\n");
  for (i = 0; i < 1U; i++) {
...
#line 186
                    {
                      sim_log_debug(259U, "Trickle", "Trickle: mark timer %hhi as pending\n", i);
...
#line 445
{
  if (/*CtpP.Router*/CtpRoutingEngineP$0$radioOn[sim_node()] && /*CtpP.Router*/CtpRoutingEngineP$0$running[sim_node()]) {
      if (!/*CtpP.Router*/CtpRoutingEngineP$0$tHasPassed[sim_node()]) {
          ...
          sim_log_debug(359U, "RoutingTimer", "Beacon timer fired at %s\n", sim_time_string());
...
#line 744
{
  ...
  sim_log_debug(294U, "FHangBug", "%s posted sendTask.\n", __FUNCTION__);
  /*CtpP.Forwarder*/CtpForwardingEngineP$0$sendTask$postTask();
}
...
#line 576
{
  ...
  sim_log_debug(200U, "AODV", "%s\t AODV: AMSend.send() dest: %d id: %d len: %d nexthop: %d\n", sim_time_string(), addr, id, len, nexthop);
  ...
  if (nexthop == 0xFFFF) {
      if (!AODV_M$rreq_pending_[sim_node()]) {
          sim_log_debug(201U, "AODV", "%s\t AODV: AMSend.send() a new destination\n", sim_time_string());
  ...
  sim_log_debug(202U, "AODV", "%s\t AODV: AMSend.send() there is a route to %d\n", sim_time_string(), addr);
...
# 46 "/opt/tinyos-2.1.2/tos/lib/net/CollectionId.nc"
inline static collection_id_t /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionId$fetch(uint8_t arg_0x2af8978ab318){
#line 46
  unsigned char __nesc_result;
#line 46

#line 46
  switch (arg_0x2af8978ab318) {
#line 46
    case 0U:
#line 46
...
#line 46
    default:
#line 46
      __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionId$default$fetch(arg_0x2af8978ab318);
#line 46
      break;
#line 46
    }
...
#line 297
  sim_log_debug(270U, "Forwarder", "%s: sending packet from client %hhu: %x, len %hhu\n", __FUNCTION__, client, msg, len);
...
#line 299
  ...
  if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$clientPtrs[sim_node()][client] == (void *)0) {
      sim_log_debug(271U, "Forwarder", "%s: send failed as client is busy.\n", __FUNCTION__);
      return EBUSY;
    }
  ...
  if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$SendQueue$enqueue(qe) == SUCCESS) {
      if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$hasState(/*CtpP.Forwarder*/CtpForwardingEngineP$0$RADIO_ON) && !/*CtpP.Forwarder*/CtpForwardingEngineP$0$hasState(/*CtpP.Forwarder*/CtpForwardingEngineP$0$SENDING)) {
          sim_log_debug(273U, "FHangBug", "%s posted sendTask.\n", __FUNCTION__);
          /*CtpP.Forwarder*/CtpForwardingEngineP$0$sendTask$postTask();
        }
      ...
      sim_log_debug(274U, "Forwarder", "%s: send failed as packet could not be enqueued.\n", __FUNCTION__);
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2af89768fc28){
#line 83
  switch (arg_0x2af89768fc28) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2af89768fc28);
#line 83
      break;
#line 83
    }
...
#line 57
  {
    sim_log_debug(174U, "Init", "LEDS: initialized.\n");
...
#line 438
{
  sim_log_debug(332U, "LI", "Link estimator init\n");
...
#line 215
  ...
  sim_log_debug(345U, "TreeRoutingCtl", "TreeRouting initialized. (used payload:%d max payload:%d!\n", sizeof /*CtpP.Router*/CtpRoutingEngineP$0$beaconMsg[sim_node()], maxLength);
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2af8973e0e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2af8973e0e18) {
#line 100
    case 0U:
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2af8973e0e18, msg, error);
#line 100
      break;
#line 100
    }
...
#line 529
  sim_log_debug(286U, "Forwarder", "%s to %hu and %hhu\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$AMPacket$destination(msg), error);

  if (error != SUCCESS) {

      sim_log_debug(287U, "Forwarder", "%s: send failed\n", __FUNCTION__);
...
#line 540
    if (/*CtpP.Forwarder*/CtpForwardingEngineP$0$hasState(/*CtpP.Forwarder*/CtpForwardingEngineP$0$ACK_PENDING) && !/*CtpP.Forwarder*/CtpForwardingEngineP$0$PacketAcknowledgements$wasAcked(msg)) {
        ...
        if (-- qe->retries) {
            sim_log_debug(288U, "Forwarder", "%s: not acked, retransmit\n", __FUNCTION__);
...
#line 91
      ...
      sim_log_debug(390U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*TestNetworkAppC.DebugMessagePool.PoolP*/PoolP$3$free[sim_node()]);
      return rval;
    }
  return (void *)0;
}
...
#line 72
  sim_log_debug(392U, "QueueC", "head <-");
  for (i = /*TestNetworkAppC.DebugSendQueue*/QueueC$2$head[sim_node()]; i < /*TestNetworkAppC.DebugSendQueue*/QueueC$2$head[sim_node()] + /*TestNetworkAppC.DebugSendQueue*/QueueC$2$size[sim_node()]; i++) {
      sim_log_debug_clear(393U, "QueueC", "[");
...
#line 77
          sim_log_debug_clear(394U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(395U, "QueueC", "] ");
    }
  sim_log_debug_clear(396U, "QueueC", "<- tail\n");
}
...
#line 251
  ...
  sim_log_debug(268U, "Forwarder", "Rexmit timer will fire in %hu ms\n", r);
}
...
#line 496
        {
          sim_log_debug(283U, "CtpForwarder", "%s: packet %hu.%hhu for client %hhu dropped.\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getOrigin(msg), /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getSequenceNumber(msg), qe->client);
      ...
      if (success) {
          ...
          sim_log_debug(285U, "CtpForwarder", "%s: forwarded packet %hu.%hhu dropped.\n", __FUNCTION__, /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getOrigin(msg), /*CtpP.Forwarder*/CtpForwardingEngineP$0$CollectionPacket$getSequenceNumber(msg));
...
{
  LedsP$Led0$clr();
  sim_log_debug(175U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 76
  ;
}
...
#line 443
{
  ...
  sim_log_debug(194U, "AODV", "%s\t AODV: del_route_table() dest:%d\n", sim_time_string(), dest);
...
#line 219
{
  ...
  sim_log_debug(188U, "AODV_DBG", "%s\t AODV: sendRERR() dest: %d\n", sim_time_string(), dest);
  ...
  if (!AODV_M$send_pending_[sim_node()]) {
      if (AODV_M$SendRERR$send(target, AODV_M$p_rerr_msg_[sim_node()], sizeof(aodv_rerr_hdr ))) {
          sim_log_debug(189U, "AODV", "%s\t AODV: sendRREQ() to %d\n", sim_time_string(), target);
          AODV_M$send_pending_[sim_node()] = TRUE;
          return TRUE;
        }
    }
...
#line 222
      sim_log_debug(260U, "Trickle", "Adjusting: timer %hhi (%u)\n", i, timeRemaining);
...
#line 257
      sim_log_debug(264U, "Trickle", "Starting sub-timer with interval %u.\n", timerVal);
...
#line 130
{
  ...
  /*DisseminationTimerP.TrickleTimerMilliC.TrickleTimerImplP*/TrickleTimerImplP$0$trickles[sim_node()][id].count = 0;
  if (/*DisseminationTimerP.TrickleTimerMilliC.TrickleTimerImplP*/TrickleTimerImplP$0$trickles[sim_node()][id].time != 0) {
      sim_log_debug(255U, "Trickle", "Resetting running trickle timer %hhu @ %s\n", id, sim_time_string());
      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 135
        {
          /*DisseminationTimerP.TrickleTimerMilliC.TrickleTimerImplP*/TrickleTimerImplP$0$Changed$set(id);
...
#line 142
    {
      sim_log_debug(256U, "Trickle", "Resetting  trickle timer %hhu @ %s\n", id, sim_time_string());
    }
}
...
#line 409
{
  ...
  b = (uint8_t *)msg->data;
  for (i = 0; i < len; i++) 
    sim_log_debug_clear(329U, "LI", "%x ", b[i]);
  sim_log_debug_clear(330U, "LI", "\n");
}
...
#line 364
{
  ...
  if (LinkEstimatorP$NeighborTable[sim_node()][idx].flags & INIT_ENTRY) {
      sim_log_debug(326U, "LI", "Init entry update\n");
  ...
  sim_log_debug(327U, "LI", "updateNeighborEntryIdx: prevseq %d, curseq %d, gap %d\n", LinkEstimatorP$NeighborTable[sim_node()][idx].lastseq, seq, packetGap);
...
#line 212
  ...
  for (i = 0; i < 10; i++) {
      if (!(LinkEstimatorP$NeighborTable[sim_node()][i].flags & VALID_ENTRY)) {
          sim_log_debug(318U, "LI", "Invalid so continuing\n");
          continue;
        }
      if (!(LinkEstimatorP$NeighborTable[sim_node()][i].flags & MATURE_ENTRY)) {
          sim_log_debug(319U, "LI", "Not mature, so continuing\n");
          continue;
        }
      if (LinkEstimatorP$NeighborTable[sim_node()][i].flags & PINNED_ENTRY) {
          sim_log_debug(320U, "LI", "Pinned entry, so continuing\n");
          continue;
        }
...
#line 517
{
  ...
  sim_log_debug(363U, "TreeRouting", "%s\n", __FUNCTION__);
...
#line 374
          ...
          sim_log_debug(65U, "TestNetworkC", "Temp value is %.3f.\n", TestNetworkC$temp[sim_node()] / TestNetworkC$num[sim_node()]);
          sim_log_debug(66U, "TestNetworkC", "Wind value is %.3f.\n", TestNetworkC$wind[sim_node()] / TestNetworkC$num[sim_node()]);
          sim_log_debug(67U, "TestNetworkC", "Humidity value is %.3f.\n", TestNetworkC$hum[sim_node()] / TestNetworkC$num[sim_node()]);
        }
      sim_log_debug(68U, "TestNetworkC", "CTP Node received packet at %s from node %hhu.\n", sim_time_string(), TestNetworkC$CollectionPacket$getOrigin(msg));
...
{
  LedsP$Led2$clr();
  sim_log_debug(181U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 106
  ;
}
...
#line 470
{
  ...
  sim_log_debug(195U, "AODV_DBG", "%s\t AODV: add_route_table() seq:%d dest:%d next:%d hop:%d\n", sim_time_string(), seq, dest, nexthop, hop);
...
#line 194
{
  ...
  sim_log_debug(186U, "AODV_DBG", "%s\t AODV: sendRREP() dest: %d send_pending_: %d\n", sim_time_string(), dest, AODV_M$send_pending_[sim_node()]);
...
#line 201
      ...
      sizeof(aodv_rrep_hdr )) == SUCCESS) {
          sim_log_debug(187U, "AODV", "%s\t AODV: sendRREP() to %d\n", sim_time_string(), dest);
          AODV_M$send_pending_[sim_node()] = TRUE;
          return TRUE;
        }
    }
...
#line 91
{
  ...
  sim_log_debug(370U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$current[sim_node()] >= 2) {
      ...
      sim_log_debug(371U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(372U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$current[sim_node()] = 2;
      ...
      sim_log_debug(373U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 87
  sim_log_debug(397U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*TestNetworkAppC.DebugSendQueue*/QueueC$2$size[sim_node()]);
...
#line 429
{
  sim_log_debug(71U, "Traffic", "UART send done.\n");
...
#line 157
  ...
  sim_log_debug(184U, "AODV", "%s\t AODV: sendRREQ() dest: %d\n", sim_time_string(), dest);
...
#line 176
      ...
      sizeof(aodv_rreq_hdr )) == SUCCESS) {
          sim_log_debug(185U, "AODV", "%s\t AODV: sendRREQ()\n", sim_time_string());
          AODV_M$send_pending_[sim_node()] = TRUE;
          return TRUE;
        }
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "TestNetworkC$wind_AODV"))
  {
    *addr = (uintptr_t)&TestNetworkC$wind_AODV[__nesc_mote];
    *size = sizeof(TestNetworkC$wind_AODV[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestNetworkC$temp_AODV"))
  {
    *addr = (uintptr_t)&TestNetworkC$temp_AODV[__nesc_mote];
    *size = sizeof(TestNetworkC$temp_AODV[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestNetworkC$hum_AODV"))
  {
    *addr = (uintptr_t)&TestNetworkC$hum_AODV[__nesc_mote];
    *size = sizeof(TestNetworkC$hum_AODV[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestNetworkC$num_AODV"))
  {
    *addr = (uintptr_t)&TestNetworkC$num_AODV[__nesc_mote];
    *size = sizeof(TestNetworkC$num_AODV[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  TestNetworkC$wind_AODV[__nesc_mote] = 0;
  TestNetworkC$temp_AODV[__nesc_mote] = 0;
  TestNetworkC$hum_AODV[__nesc_mote] = 0;
  TestNetworkC$num_AODV[__nesc_mote] = 0;
